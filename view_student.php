			...
			<div class="main-body">
				...
				<section id="main-form">
					...
					<div class="container1 bg-danger" id="formsetting">
						<h3 class="text-center text-black pb-2 pt-2 font-weight-bold">View Student Detail</h3>
						<hr>
									...
									?>
										<tbody>
											<tr>
												...
												<td>
													<a style="color:white; text-decoration: none" href="student_image/<?php echo $row['photo']; ?>">
														<img src="student_image/<?php echo $row['photo']; ?>" width="50" height="50"></a>
												</td>
												<td>
													<a style="text-decoration: none; font-weight: bold; color:blue;"  href="edit_student.php?edit_student=<?php echo $row['st_id']; ?>"><ins>Edit</ins></a>
													<a style="text-decoration: none; font-weight: bold; color:blue;" href="delete_student_detail.php?delete_student=<?php echo $row['st_id']; ?>"><ins>Delete</ins></a>
												</td>
											</tr>
										</tbody>
										<?php } ?>
