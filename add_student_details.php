...
if(isset($_POST['add'])){
	...
	if(!$image_type == 'image/jpg' or !$image_type == 'image/png')
	{
		...
		else if($image_size<= 2000)
		{
			...
			$sql = "insert into student_detail (fname, lname, email,  father_name, birthdate, mobile, gender, district, city, state, nation, photo) values('$fname', '$lname', '$email','$fathername',  '$birthdate', '$mobile', '$gender','$district','$city', '$state','$nation', '$image')";
			...
			<div class="main-body">
				...
				<span class="text-center text-white font-weight-bold"><?php echo @$match_err; echo @$size_error;   ?> </span>  	
					...
					<div class="container1 bg-danger" id="formsetting">
						<h3 class="text-center text-black pb-2 pt-2 font-weight-bold">Add Student Details</h3>
						<hr>
						...
						<div class="row">
							<div class="col-md-5 col-sm-5 col-12 m-auto">
								...
								<div class="form-group">
									...
									<input type="text" name="fathername" placeholder="Enter your father's name" class="form-control">
								</div>
